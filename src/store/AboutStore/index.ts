...
export const saveData = createEffect(async (data:{
    firstName:string, lastName:string, birthDate:string, cityOfResidence:string | null, gender:string | null, hasPet:boolean | null,
    smallAboutMe:string | null, aboutMe:string | null
}) => {
